...
import {View, Text, TouchableOpacity, ScrollView, Animated, Dimensions, StyleSheet, Modal, AppState, Alert } from 'react-native';
...
const QUICK_ACTIONS = [
    {
        ...
        label: "Add\nMedicine",
        route:"/tabs/medications/add" as const,
        color: "#7d3c2c",
        gradient: ["#A0280B", "#7d3c2c"] as [string, string],
    },
    {
        ...
        color: "#0b83a0",
        gradient: ["#0bbbe6", "#0b83a0"] as [string, string],
    },
    {
        ...
        color: "#a00b39",
        gradient: ["#eb1557", "#a00b39"] as [string, string],
    },
    {
        icon: "medical-outline" as const,
        label: "Refill\nTracker",
        route: "/tabs/refills" as const,
        color: "#E64A19",
...
export default function HomeScreen(){
    ...
    const laodMedications = useCallback(async()=>{
        try {
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
            <LinearGradient colors={["#872f1a", "#6b2514"]} style={styles.header}>
                ...
                </View>
                {
                    todaysMedications.length === 0 ? (
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyStateText}>No medicines for today</Text>
                            <Link href="/tabs/medications/add">
                                <TouchableOpacity style={styles.addMedicationButton}>
                                <Text style={styles.addMedicationButtonText}>Add Medicine</Text>
                                </TouchableOpacity>
                            </Link>
                        </View>
                    ): (
