            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                ...
                if (todayStr !== selectedStr) {
                  Alert.alert(
                    "Not Today's Medication",
                    "You are trying to take a medication for a different date. Please select today's date to take this dose."
                  );
                  return;
                }
