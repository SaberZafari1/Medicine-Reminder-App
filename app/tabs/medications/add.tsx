                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.container}>
                            ...
                            >
                                <View style={styles.dateIconContainer}>
                                    <Ionicons name='calendar' size={20} color="#A0280B"/>
                                </View>
                                ...
                                form.frequency && form.frequency !== "As needed" && (
                                    <View style={styles.timesContainer}>
                                        ...
                                        form.times.map((time, index)=>(
                                            ...
                                            >
                                            <View style={styles.timeIconConatainer}>
                                                <Ionicons name='time-outline' size={20} color={"#A0280B"} />
                                            </View>
                                ...
                                <View style={styles.switchRow}>
                                    <View style={styles.switchLabelContainer}>
                                        <View style={styles.iconContainer}>
                                            <Ionicons name='notifications' color="#A0280B"/>
                                        </View>
                                        <View>
                                            <Text style={styles.switchLabel}>Reminders</Text>
                                            <Text style={styles.switchSubLabel}>Get notified</Text>
                                        </View>
                                    </View>
                                    <Switch
                                    value={form.reminderEnabled}
                                    trackColor={{false: "#ddd", true: "#A0280B"}}
                                    thumbColor={"white"}
                                    onValueChange={(value)=>{
                        ...
                        <View style={styles.section}>
                            <View style={styles.textAreaContainer}>
                                ...
                                placeholderTextColor="#999"
                                value={form.notes}
                                onChangeText={(text)=>({...form, notes: text})}
                                multiline
                                numberOfLines={4}
